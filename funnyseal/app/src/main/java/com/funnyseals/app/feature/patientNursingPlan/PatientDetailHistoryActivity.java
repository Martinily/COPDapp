...
public class PatientDetailHistoryActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Toast.makeText(PatientDetailHistoryActivity.this, mPlanId,
                Toast.LENGTH_SHORT).show();
        Toast.makeText(PatientDetailHistoryActivity.this, mPatientId,
                Toast.LENGTH_SHORT).show();
            ...
            try {
                ...
                for( i=0;i<jsonArray.length();i++){
                    if(jsonArray.getJSONObject(i).getString("item_type").equals("sports"))
                    {
                        ...
                        mHistorysports_attentions.add(jsonArray.getJSONObject(i).getString("sAttention"));
                    ...
                    else if(jsonArray.getJSONObject(i).getString("item_type").equals("med"))
                    {
                        ...
                        mHistorymedicine_attentions.add(jsonArray.getJSONObject(i).getString("mAttention"));
                    ...
                    else if(jsonArray.getJSONObject(i).getString("item_type").equals("app"))
                    {
                        ...
                        mHistoryinstrument_Titles.add(jsonArray.getJSONObject(i).getString("appName"));
                        mHistoryinstrument_nums.add(jsonArray.getJSONObject(i).getString("appTime"));
                        mHistoryinstrument_attentions.add(jsonArray.getJSONObject(i).getString("appAttention"));
        ...
        String[] historymedicine_Title=(String[]) mHistorymedicine_Titles.toArray(new String[size]);//药物名称
        String[] historymedicine_num=(String[]) mHistorymedicine_nums.toArray(new String[size]);//药物数量
        String[] historymedicine_attention=(String[]) mHistorymedicine_attentions.toArray(new String[size]);//药物注意事项
        String[] historymedicine_time=(String[]) mHistorymedicine_times.toArray(new String[size]);//药物时间

        String[] historyinstrument_Title=(String[]) mHistoryinstrument_Titles.toArray(new String[size2]);//器械名称
        String[] historyinstrument_num=(String[]) mHistoryinstrument_nums.toArray(new String[size2]);//器械时长
        String[] historyinstrument_attention=(String[])mHistoryinstrument_attentions.toArray(new String[size2]);//器械注意事项

        String[] historysports_Title= (String[]) mHistorysports_Titles.toArray(new String[size3]);//运动名称
        String[] historysports_num= (String[]) mHistorysports_nums.toArray(new String[size3]);//运动时长
        String[] historysports_attention= (String[]) mHistorysports_attentions.toArray(new String[size3]);//运动注意事项
        ...
        for(int i=0;i<historymedicine_Title.length;i++) {
            ...
            if(historymedicine_time[i].equals("-")){
                ...
                if(historymedicine_time[i].charAt(0)=='1') time+="早饭前 ";
                if(historymedicine_time[i].charAt(1)=='1') time+="早饭后 ";
                if(historymedicine_time[i].charAt(2)=='1') time+="午饭前 ";
                if(historymedicine_time[i].charAt(3)=='1') time+="午饭后 ";
                if(historymedicine_time[i].charAt(4)=='1') time+="晚饭前 ";
                if(historymedicine_time[i].charAt(5)=='1') time+="晚饭后 ";
            }
        ...
        ListView listview=(ListView) findViewById(R.id.listViewsikerhistory);
        listview.setAdapter(new MyAdapter());

        //退出按钮的监听
        Button quitsickerhistory=(Button) findViewById(R.id.quitsickerhistory);
        ...
        usehistory.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                new AlertDialog.Builder(PatientDetailHistoryActivity.this).setTitle("我的提示").setMessage("确定切换当前护理计划？")
                        .setPositiveButton("确定", new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int which) {
                                ...
                                new Thread(() -> {
                                    Socket socket;
                                    JSONObject jsonObject=new JSONObject();
                                    MyApplication application=(MyApplication) PatientDetailHistoryActivity.this.getApplication();
                                    try {
    ...
    class MyAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            if(convertView==null)
            {
                view= LayoutInflater.from(PatientDetailHistoryActivity.this).inflate(R.layout.historydetail_item,null);
            ...
            mHolder.cardhistory_title.setText(medicine_list.get(position).get("historytitle").toString());
            mHolder.cardhistory_image.setImageResource((int)medicine_list.get(position).get("historyimg"));
            mHolder.cardhistory_num.setText(medicine_list.get(position).get("historynum").toString());
            mHolder.cardhistory_numdetail.setText(medicine_list.get(position).get("historynumdetail").toString());
            mHolder.cardhistory_attention.setText(medicine_list.get(position).get("historyattention").toString());
            mHolder.cardhistory_time.setText(medicine_list.get(position).get("historytime").toString());

            //
            final String medicinenametime=medicine_list.get(position).get("historytitle").toString();
            //
