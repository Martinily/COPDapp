...
public class DoctorDetailHistoryActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mPickPatient.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(DoctorDetailHistoryActivity.this, PickPatientActivity.class);
                //传输医生编号
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == 1000 && resultCode == 1001) {
            ...
            new Thread(() -> {
                Socket socket;
                JSONObject jsonObject=new JSONObject();
                MyApplication application=(MyApplication) DoctorDetailHistoryActivity.this.getApplication();
                try {
    ...
    class MyAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            if(convertView==null)
            {
                view= LayoutInflater.from(DoctorDetailHistoryActivity.this).inflate(R.layout.historydetail_item,null);
