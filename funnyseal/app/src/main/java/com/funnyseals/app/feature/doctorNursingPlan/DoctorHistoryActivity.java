...
public class DoctorHistoryActivity extends AppCompatActivity {
    ...
    class MyAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            if(convertView==null){
                view= LayoutInflater.from(DoctorHistoryActivity.this).inflate(R.layout.historydate_item,null);
            ...
            mHolder.cardhistory_date.setText(doctorhistory_list.get(position).get("doctorhistorydate").toString());
            mHolder.cardhistory_judgeuse.setImageResource((int)doctorhistory_list.get(position).get("doctorhistoryuse"));
            ...
            moredetailhistory.setOnClickListener(new View.OnClickListener(){
                ...
                {
                    //
                    Intent intent= new Intent(DoctorHistoryActivity.this,DoctorDetailHistoryActivity.class);
                    Bundle bundle=new Bundle();
                    bundle.putCharSequence("planid",doctorhistory_list.get(position).get("doctorhistoryid").toString());  //患者护理计划编号
