    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        button1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (m_data1.isEmpty()) m_data1="-1";
                final String m_dataf1=m_data1;
                String m_data2=editText2.getText().toString();
                if (m_data2.isEmpty()) m_data2="-1";
                final String m_dataf2=m_data2;
                String m_data3=editText3.getText().toString();
                if (m_data3.isEmpty()) m_data3="-1";
                final String m_dataf3=m_data3;
                if(m_data1.equals("-1")&m_data2.equals("-1")&m_data3.equals("-1")) Toast.makeText(HealthCenterUpdateActivity.this,"请输入至少一项数据",Toast.LENGTH_LONG).show();
                else {
                    Thread thread=new Thread(()->{
                        ...
                        try {
                            ...
                            Looper.prepare();
                            if (jsonObject.getString("data_result").equals("true")) Toast.makeText(HealthCenterUpdateActivity.this,"数据添加成功",Toast.LENGTH_LONG).show();
                            else Toast.makeText(HealthCenterUpdateActivity.this,"数据添加失败",Toast.LENGTH_LONG).show();
                            Looper.loop();
