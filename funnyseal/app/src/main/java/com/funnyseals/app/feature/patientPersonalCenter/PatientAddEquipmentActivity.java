...
public class PatientAddEquipmentActivity extends AppCompatActivity {
    ...
    protected void onCreate (Bundle savedInstanceState) {
        ...
        init();
        ArrayAdapter<CharSequence> adapter_name = ArrayAdapter.createFromResource(this, R.array
                .select_name, android.R.layout.simple_spinner_item);
        ...
        ArrayAdapter<CharSequence> adapter_state = ArrayAdapter.createFromResource(this, R.array
                .select_state, android.R.layout.simple_spinner_item);
